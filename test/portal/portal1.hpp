...
glm::mat4 func1_rev(int i, int j) {
  return glm::rotate(glm::mat4(1), glm::radians(-90.0f), glm::vec3(0, 1, 0)) * glm::translate(glm::mat4(1), glm::vec3(0, 1, -2));
}
...
glm::mat4 func2_rev(int i, int j) {
  return glm::rotate(glm::mat4(1), glm::radians(-90.0f), glm::vec3(0, 1, 0)) * glm::translate(glm::mat4(1), glm::vec3(0, -10 + 1, -2));
}
...
glm::mat4 func3_rev(int i, int j) {
  return glm::rotate(glm::mat4(1), glm::radians(-90.0f), glm::vec3(0, 1, 0)) * glm::translate(glm::mat4(1), glm::vec3(0, -20 + 1, -2));
}
